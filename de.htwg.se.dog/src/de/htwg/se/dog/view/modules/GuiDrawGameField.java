    ...
    public void mousePressed(MouseEvent arg0) {
        for (Entry<Integer, Arc2D.Double> a : gMap.entrySet()) {
            if (a.getValue().contains(arg0.getX(), arg0.getY())) {
                ...
                /** TODO bug -> kann nur eine pro spieler auswählen **/
                if (array[feldId].getFigureOwnerNr() == controller.getCurrentPlayerID()) {
                ...
                } else if (second && fromto.size() > 0 && array[feldId].getFigure() != null && !array[feldId].isBlocked()) {
                    if (fromto.contains(feldId)) {
