...
public class GuiDrawFigures extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.setColor(col);
        g2d.fill(new Arc2D.Double(1, FIVE, FOURTY, FOURTY, 0, CIRCLE, Arc2D.OPEN));
    ...
    /**
     * change the playerid of the panel
     * 
     * @param playernum
     *            the panel to change to
     * @param fignum
     *            number of figures the player has
     */
